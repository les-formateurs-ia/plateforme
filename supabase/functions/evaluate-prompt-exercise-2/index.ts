// Duplicat indépendant pour le module "Exercez-vous 2" (tables *_2, bucket media-exercise-outputs-2) — voir supabase/migrations/0065_practice2_module.sql. Logique identique à evaluate-prompt-exercise.

...
export function ShimBtn({ children, onClick, sm, full }: { children: ReactNode; onClick?: () => void; sm?: boolean; full?: boolean }) {
  return (
...
export function VBtn({ children, onClick, sm, full }: { children: ReactNode; onClick?: () => void; sm?: boolean; full?: boolean }) {
  const th = useTh();
  return (

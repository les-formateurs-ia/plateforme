...
import { listExerciseTags, createExerciseTag, renameExerciseTag, deleteExerciseTag, type ExerciseTag } from "@/app/lib/exerciseTags2";
...
export function TagManagerDialog2({ open, onOpenChange, onChanged }: {
  open: boolean;

...
} from "@/app/lib/htmlExercises2";
import { listExerciseTags, getTagIdsForExercise, setExerciseTags, type ExerciseTag } from "@/app/lib/exerciseTags2";
...
export function HtmlExerciseEditDialog2({
  ...
  const [visibility, setVisibility] = useState<ExerciseVisibility2>("private");
  ...
  const [original, setOriginal] = useState<{
    name: string; description: string; htmlDraft: string; visibility: ExerciseVisibility2; selected: Set<string>; selectedTags: Set<string>;
  } | null>(null);

...
import { updateHtmlExerciseContent } from "@/app/lib/htmlExercises2";
import {
...
} from "@/app/lib/htmlExercise2";

const RED = "#e5484d";

export function HtmlExercisePage2() {
  const th = useTh();
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 space-y-6">
      <div>
        <button onClick={() => navigate("/practice2/html")} className="flex items-center gap-1.5 text-sm mb-2 transition-colors hover:opacity-70" style={{ color: th.fg3 }}>

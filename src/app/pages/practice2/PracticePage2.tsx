...
export function PracticePage2() {
  ...
  const BLOCKS = [
    { emoji: "✨", title: "Exercices pour vous", desc: "Bac à sable HTML/JS — colle du code et vois-le tourner en direct, exactement comme le Playground d'une leçon.", tag: "Playground", path: "/practice2/html", color: `${th.grad2}`, glow: `${th.gradShadow(0.12)}` },
    { emoji: "🎨", title: "Génération images & vidéos", desc: "Entraînement à la rédaction de prompts pour générateurs d'image et de vidéo IA — comparaison avant/après correction.", tag: "IA · Image & Vidéo", path: "/practice2/media", color: "#fbc2ad", glow: "rgba(251,194,173,0.12)" },
    { emoji: "⚡", title: "Exercices prompts", desc: "Entraînement exclusif à la rédaction de prompts professionnels. Aucun QCM — pratique pure.", tag: "20 exercices", path: "/practice2/prompts", color: "#6adeb1", glow: "rgba(106,222,177,0.12)" },

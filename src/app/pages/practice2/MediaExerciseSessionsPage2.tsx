...
import { createExerciseSession, renameExerciseSession, deleteExerciseSession } from "@/app/lib/exerciseSessions2";
import { listMediaExerciseSessions, type MediaExerciseSession } from "@/app/lib/mediaExercise2";
...
export function MediaExerciseSessionsPage2() {
  const th = useTh();
